-- ============================================
-- Village Voice Community Seed Data - AUTO VERSION
-- This script automatically finds topic IDs AND user ID
-- ============================================
-- 
-- INSTRUCTIONS:
-- Just run this entire script - no replacements needed!
-- It will use the first available user in your database
--
-- ============================================
...
BEGIN
  ...
  RAISE NOTICE 'Pregnancy Journey topic ID: %', topic_pregnancy_id;
  ...
  RAISE NOTICE '✅ Seed data inserted successfully! Created 20 threads with replies.';
END $$;
